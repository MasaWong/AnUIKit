 ...
 * @since 16/3/15
 */
public class AnRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    // Maps to ProgressBar.Large style
    public static final int LARGE = AnProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = AnProgressDrawable.DEFAULT;
    ...
    private AnProgressDrawable mProgress;
    ...
    public void setSize(int size) {
        if (size != AnProgressDrawable.LARGE && size != AnProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == AnProgressDrawable.LARGE) {
     ...
     * @param context
     */
    public AnRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public AnRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        ...
        mProgress = new AnProgressDrawable(getContext(), this);
